...
#submit {
	cursor: pointer;
	transition: .5s ease; &: hover { color : white;
	background: black;
}
		...
		<div class="content">
			...
			<form action="postjob" method="post" autocomplete="off">
				<label>Company name</label> <input type="text" name="company_name"
					required> <label>Company Email</label> <input type="text"
					name="company_email" required> <label>Job role</label> <input
					type="text" name="job_role" required> <label>Elibility</label>
				<br>
				<textarea name="eligible" id="eligible" cols="40" rows="5"></textarea>
				<br> <label>Skills required</label> <input type="text"
					name="skills"
					placeholder="enter mulitple skills with ',' seperator" required>

				<label>Batch</label> <input type="text" name="batch" required>

				<label>Hiring package</label> <input type="text" name="package"
					placeholder="hiring package in LPA" required>
