            ...
            <table style="border-collapse: collapse">
                ...
                try {
                    ...
                    if (rs != null) {
                        ...
                        %>
                        <tr>
                            <td colspan="7" style="text-align:center;padding:10px;">No companies have posted for recruitment.</td>
                        </tr>
                        <%
                    }
                } catch (Exception e) {
...
<footer>
    ...
    <div class="recruiters">
        <center>
            ...
            <img src="images/r2.png" class="img3" width="1000px" height="250px" alt="company3"/>
        </center>
    </div>
</footer>
</body>
