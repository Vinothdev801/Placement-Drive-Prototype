		...
		<div class="content">
			...
			<form action="update" method="post">
				...
				<div class="form">
					...
					<div class="label">
						<label>Name</label> <label>Reg No</label> <label>E-Mail</label> <label>D.O.B</label>
						<label>Course</label> <label>Skills</label> <label>Photo
							link</label> <label>Resume link</label>
					</div>
					...
					<div class="input">
						...
						<input type="email" name="email"
							value="<%=rs.getString("email")%>"> <input type="date"
							name="dob" value="<%=rs.getString("dob")%>"> <select
							name="course">
							<option value="<%=rs.getString("course")%>">select your
								course</option>
						...
						</select> <input type="text" name="skills"
							value="<%=rs.getString("skills")%> "> <input type="url"
							name="photo" value="<%=rs.getString("photo")%>"
							placeholder="give current photo G-drive link"> <input
							type="url" name="resume" value="<%=rs.getString("resume")%>"
							placeholder="updated resume link">
						<%} %>
					</div>
				</div>
